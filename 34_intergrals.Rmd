...
<iframe width="560" height="315" src="https://www.youtube.com/embed/rfG8ce4nNh0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="border:1;display:block;margin:10px auto;"></iframe>
...
Some of these functions are plotted in the bottom panel of @fig-integralc as dotted lines.


```{r, #fig-integralc, fig.cap="The Many Indefinite Integrals of a Function", echo = FALSE}
...
```{r, #fig-defintfig, echo = FALSE, fig.cap="The Riemann Integral as a Sum of Evaluations"}
